...
#Insert into some values in the winner table::
...
#insert in the some values in the movies::
...
#Insert some values in the nominees::
...
#show all columns from the tables::
show columns from movies;
show columns from nominees;
show columns from winners;

#show all values in the tables::
select * from movies;
